...
1. _[!UICONTROL 내 토큰]_ 페이지에서 _추가 작업_ 아이콘(**...**)을 클릭합니다. 토큰 이름 옆에 있는 **[!UICONTROL 편집]**&#x200B;을 선택하세요.
...
1. _[!UICONTROL 내 토큰]_ 페이지에서 _추가 작업_ 아이콘(**...**)을 클릭합니다. 토큰 이름 옆에 있는 **[!UICONTROL 삭제]**&#x200B;를 선택합니다.
