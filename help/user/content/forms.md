...
![양식 라이브러리에 액세스](./assets/forms-list.png){width="700" zoomable="yes"}
...
| 초안과 함께 게시됨 | 게시된 양식에서 초안을 만들 때 게시된 버전은 랜딩 페이지 또는 랜딩 페이지 템플릿에서 사용할 수 있으며 시각적 디자인 공간에서 초안 콘텐츠를 수정할 수 있습니다. 초안 버전을 게시하면 현재 게시된 버전이 대체되며 콘텐츠는 사용 중인 랜딩 페이지 또는 랜딩 페이지 템플릿에서 업데이트됩니다. 사용 가능한 작업: <br/><ul><li>이름, 설명 또는 감사 페이지 편집<li>랜딩 페이지 또는 랜딩 페이지 템플릿에 추가<li>시각적 디자인 공간에서 초안 버전 편집<li>초안 버전 게시<li>복제<li>삭제(사용하지 않는 경우)<li>포함 코드 |
