...
>abstract="이메일 또는 이메일 템플릿의 테마를 선택하여 브랜드와 디자인에 맞는 스타일을 적용할 수 있습니다."
...
* 빈 캔버스(_처음부터 디자인_)에서 전자 메일 또는 전자 메일 템플릿을 만들 때 _테마 모드_&#x200B;를 선택하여 내 브랜드에 맞는 테마를 사용하여 콘텐츠를 빌드할 수 있습니다. _수동 모드_&#x200B;를 선택하는 경우 테마를 적용하려면 전자 메일 또는 전자 메일 서식 파일에 대한 디자인을 다시 설정해야 합니다.
...
* 사용자 지정 테마에 대한 변경 사항이 이미 사용 중인 모든 이메일 또는 이메일 템플릿에 자동으로 캐스케이드되지 않습니다. 테마를 새로 고치려면 각 테마의 콘텐츠를 편집합니다.
...
이메일 및 이메일 템플릿 콘텐츠에 적용할 수 있는 나만의 브랜드 테마를 정의합니다.
...
* **[!UICONTROL 변형 추가]**&#x200B;를 클릭하여 각각 고유한 팔레트 및 컨트롤이 있는 _light_ 및 _dark_ 모드와 같은 여러 색상 변형을 만듭니다.
...
>[!NOTE]
>
>저장된 변경 사항은 현재 테마를 사용 중인 모든 이메일 또는 이메일 템플릿에 자동으로 캐스케이드되지 않습니다. 테마를 새로 고치고 업데이트된 스타일을 일치시키려면 각 항목의 콘텐츠를 편집하십시오.
...
>[!NOTE]
>
>저장된 테마 변경 사항은 현재 테마를 사용 중인 모든 이메일 또는 이메일 템플릿에 자동으로 캐스케이드되지 않습니다. 테마를 새로 고치고 업데이트된 스타일을 일치시키려면 각 항목의 콘텐츠를 편집하십시오.
...
새 이메일 또는 이메일 템플릿을 만들 때 컨텐츠 작성 프로세스를 간소화하고 디자인이 정의된 표준에 맞게 조정되도록 브랜드 테마를 사용하도록 선택할 수 있습니다. 새 조각의 경우 조각을 저장하기 전에 테마를 적용할 수도 있습니다. 조각은 해당 시점부터 _테마 모드_&#x200B;에 유지되며 _테마 모드_&#x200B;에 있는 전자 메일 및 전자 메일 템플릿에 추가할 수 있습니다.
