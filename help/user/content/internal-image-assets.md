...
1. _[!UICONTROL 자산 추가]_ 대화 상자에서 시스템에서 하나 이상의 파일을 파일 상자로 끌어서 놓습니다.
   ...
   ![폴더에 자산 추가](./assets/assets-add-dialog.png){width="500"}
...
다음 방법 중 하나를 사용하여 자산을 삭제합니다.

* 자산 세부 정보로 이동하여 **[!UICONTROL 을(를) 클릭합니다. 오른쪽 상단에서]**&#x200B;을(를) 더 보고 옵션에서 **[!UICONTROL 삭제]**&#x200B;을(를) 선택하십시오.

  ![자산에 대한 액세스 작업](./assets/assets-details-more-menu.png){width="450" zoomable="yes"}

* _[!UICONTROL Assets]_ 목록 페이지에서 _자세히_ 아이콘(**[!UICONTROL ...]**)을 클릭합니다. 자산 항목 옆에 있는 옵션에서 **[!UICONTROL 삭제]**&#x200B;를 선택합니다.
...
* _[!UICONTROL Assets]_ 목록 페이지에서 _자세히_ 아이콘(**[!UICONTROL ...]**)을 클릭합니다. 자산 항목 옆에 있는 옵션에서 **[!UICONTROL 바꾸기]**&#x200B;를 선택합니다.
...
* _[!UICONTROL Assets]_ 목록 페이지에서 _줄임표_(**[!UICONTROL ...]**)를 클릭합니다. 자산 항목 옆에 있는 옵션에서 **[!UICONTROL 다운로드]**&#x200B;를 선택합니다.
...
폴더 또는 폴더 내 에셋에 작업을 적용할 수 있습니다. _자세히_ 아이콘(**...**)을 클릭합니다. 폴더 옆에 를 표시하여 적용할 수 있는 작업을 표시합니다.
...
시각적 디자인 공간에서 왼쪽 사이드바의 _Assets_ 아이콘( ![Assets 아이콘](../../assets/do-not-localize/icon-assets-me.svg))을 선택합니다.

이 작업은 사용 가능한 에셋 목록을 표시하는 도구 패널을 변경합니다. 이미지 에셋을 시각적 캔버스에 추가하는 방법에는 여러 가지가 있습니다.

* 왼쪽 탐색에서 이미지 썸네일을 끌어서 놓습니다.

* 이미지 구성 요소를 캔버스에 추가하고 구성 요소에서 **[!UICONTROL 자산 선택]**&#x200B;을 클릭하여 _[!UICONTROL 자산 선택]_ 대화 상자를 엽니다.
