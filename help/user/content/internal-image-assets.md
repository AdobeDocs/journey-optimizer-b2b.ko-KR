...
내부 이미지 에셋 저장소는 콘텐츠를 디자인하는 기본 에셋 소스이며, 사용 가능한 에셋을 쉽게 관리하고 사용하여 계정 여정을 지원하는 콘텐츠를 디자인할 수 있습니다.
...
폴더 또는 폴더 내 에셋에 작업을 적용할 수 있습니다. 폴더 옆에 있는 _자세히_ 아이콘(**...**)을 클릭하여 적용할 수 있는 작업을 표시합니다.
