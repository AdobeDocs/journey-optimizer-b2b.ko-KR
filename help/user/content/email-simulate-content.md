...
1. _[!UICONTROL 테스트를 위해 직원 추가]_ 대화 상자에서 연락처의 전체 이메일 주소를 입력합니다.
   ...
   여러 연락처를 추가하려면 쉼표로 구분하여 주소를 입력하십시오.
