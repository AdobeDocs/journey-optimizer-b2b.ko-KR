...
>[!IMPORTANT]
>
>**WhatsApp 동의 관리**: Meta의 정책 및 해당 규정에 따라 모든 WhatsApp 마케팅 메시지는 커뮤니케이션 수신을 선택한 수신자에게만 전송되어야 합니다. WhatsApp 수신자는 언제든지 옵트아웃 키워드로 회신하여 옵트아웃할 수 있습니다. 옵트아웃 응답은 자동으로 적용되며, 해당 프로필은 향후 마케팅 메시지 대상자에서 제거됩니다. 배달 시 WhatsApp 동의 환경 설정을 평가하는 방법에 대한 자세한 내용은 [동의 환경 설정](./channels-consent-preferences.md)을 참조하십시오.
