...
게시된 브랜드는 AI [브랜드 정렬](./brand-alignment.md) 및 콘텐츠 생성 도구의 **[!UICONTROL 브랜드]** 옵션에서 액세스할 수 있습니다. <!-- [Learn more about content generation](gs-generative.md) -->
...
1. 초안 업데이트 작업을 하면서 **[!UICONTROL 저장]**&#x200B;을 클릭한 다음 _Live_ 버전을 바꿀 준비가 되면 **[!UICONTROL 게시]**&#x200B;을 클릭합니다.
