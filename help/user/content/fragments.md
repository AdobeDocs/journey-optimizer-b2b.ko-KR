...
이름별로 조각을 검색하려면 검색 막대에 일치 항목 텍스트 문자열을 입력합니다. _필터_ 아이콘을 클릭하여 표시된 항목을 지정된 조건에 따라 필터링합니다.
...
* _[!UICONTROL 조각]_ 목록 페이지에서 조각 이름 옆에 있는 _자세히_(**...**) 아이콘을 클릭하고 **[!UICONTROL 복제]**&#x200B;를 선택합니다.
