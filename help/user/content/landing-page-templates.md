---
title: 랜딩 페이지 템플릿
description: 랜딩 페이지 템플릿 만들기, 관리 및 재사용 - 처음부터 디자인하고, HTML을 가져오고, Journey Optimizer B2B Edition에서 마케팅 팀을 복제하고, 삭제하고, 사용을 추적합니다.
...
Adobe Journey Optimizer B2B Edition에서 랜딩 페이지 템플릿에 액세스하려면 **[!UICONTROL 콘텐츠 관리]** > **[!UICONTROL 템플릿]**&#x200B;으로 이동하십시오. 탐색 패널의 _[!UICONTROL WEB]_&#x200B;에서 **[!UICONTROL 랜딩 페이지 템플릿]**&#x200B;을 선택합니다.
...
>[!NOTE]
>
>사용 가능한 디자인 도구는 랜딩 페이지 디자인에 사용되는 도구와 동일합니다. The difference is that this content is saved as a template that can be reused across multiple landing pages.
...
* 목록 페이지 - 줄임표(**...**) 클릭 템플릿 옆에 있는 **[!UICONTROL 편집]**&#x200B;을 선택하세요.
...
* _[!UICONTROL 랜딩 페이지 템플릿]_ 목록 페이지에서 줄임표(...)를 클릭합니다. 템플릿 옆에 있는 **[!UICONTROL 복제]**&#x200B;를 선택합니다.
...
* _랜딩 페이지 템플릿_ 목록 페이지에서 줄임표(...)를 클릭합니다. 템플릿 옆에 있는 **[!UICONTROL 삭제]**&#x200B;를 선택합니다.
...
_[!UICONTROL 랜딩 페이지 만들기]_ 페이지에서 _디자인 템플릿 선택_ 섹션을 사용하여 템플릿에서 콘텐츠를 빌드합니다.

생성된 랜딩 페이지 템플릿 중 하나를 사용하여 콘텐츠 작성을 시작하려면 다음 단계를 수행하십시오.

1. _콘텐츠 편집_ 페이지에서 시각적 디자인 공간에 액세스합니다.

   _[!UICONTROL 랜딩 페이지 만들기]_ 페이지에서 기본적으로 _샘플 템플릿_ 탭이 선택됩니다.
...
1. 시각적 콘텐츠 디자인 공간에서 필요에 따라 콘텐츠를 편집합니다.
