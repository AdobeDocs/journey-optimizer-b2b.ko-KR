...
>title="완성도 점수"
>abstract="완성도 점수는 판매 준비가 된 구매 그룹의 멤버십이 얼마나 잘 일치하는지를 반영합니다."
...
>title="역할 완성도 계산"
>abstract="역할 완성도 점수는 역할에 할당된 구성원 수를 기준으로 백분율로 계산됩니다."
...
구매 그룹 완결성 점수는 개별 역할 완결성 점수를 합산합니다. 이 계산은 정의된 모든 역할에 걸쳐 그룹 구매 준비를 전체적으로 볼 수 있도록 합니다.

### 구매 그룹 완결성 공식

구매 그룹 완결성 퍼센트는 다음 공식을 사용하여 계산됩니다.
...
* `Role Completeness %` = 개별 역할 완전성 비율(0-100%)
