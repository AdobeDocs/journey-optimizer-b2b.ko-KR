...
1. **[!UICONTROL 조건 추가]**&#x200B;를 클릭하고 역할에 대한 조건부 규칙을 정의합니다.
   ...
   * XDM 관계형 스키마에서 [정의된 사용자](../admin/xdm-field-management.md#relational-schemas)와(과) 관련된 구성된 사용자 지정 개체가 있는 경우 **[!UICONTROL 사용자 지정 개체]** 목록을 확장하여 역할 조건에서 사용하십시오.

     ![역할 템플릿 사용자 지정 개체 조건 추가](assets/roles-template-role-condition-custom-object.png){width="700" zoomable="yes"}

   * 필요한 경우 역할에 일치 기준을 더 구체화하는 다른 속성/객체 및 조건을 추가합니다.
...
1. 역할 템플릿 페이지의 오른쪽 상단에서 **[!UICONTROL 완성도 점수 설정]**&#x200B;을 클릭합니다.

   ![역할 템플릿 - 완성도 점수 설정 단추](./assets/buying-group-details-edit-roles-completeness-settings.png){width="700" zoomable="yes"}
