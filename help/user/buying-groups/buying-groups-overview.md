...
B2B 판매 및 마케팅 활동에서 계정은 모든 전략의 핵심입니다. 각 계정에는 관련된 사람들의 그룹이 있으며, 이 사람들은 계정의 직원이거나 계정과 관련된 업무를 담당하는 계약자일 수 있습니다. 계정은 계층 구조를 갖고 있으며, 계층의 서로 다른 수준에서 다양한 제품이 판매될 수 있습니다. 예를 들어 Adobe Experience Platform은 기업 수준에서 최상위 계정에 판매될 수 있고, Adobe Photoshop은 대기업의 디자인 부서와 같이 조직 내의 사업부나 부서 수준의 계정에 판매될 수 있습니다.

![계정 역할 다이어그램](assets/account-roles-diagram.png){width="800"}

계정 내에는 _구매 그룹_&#x200B;을 구성하는 하위 집합이 있을 수 있습니다. 이들은 궁극적으로 구매 결정을 내리는 사람들이므로 마케터의 특별한 관심이 필요하며, 이들에게는 해당 계정과 관련된 다른 사람들과는 다른 정보를 제공해야 할 수도 있습니다. 구매 그룹은 다양한 제품 라인이나 서비스를 담당하는 다양한 사람들로 구성될 수 있습니다. 예를 들어 사이버 보안 제품의 구매를 승인하기 위해서는 일반적으로 최고정보관리책임자나 최고보안책임자와 법무 부서 담당자가 필요하지만 버그 추적 제품의 경우에는 일반적으로 엔지니어링 담당 부책임자와 IT 책임자가 구매 그룹의 멤버로 포함됩니다.

![비디오](../../assets/do-not-localize/icon-video.svg){width="30"} [비디오 개요 보기](#overview-video)

## 주요 구성 요소

Journey Optimizer B2B 에디션에서 판매 팀이 판매를 담당하는 솔루션을 기반으로 타깃 계정 목록에 누락된 멤버를 식별하는 구매 그룹을 설정하여 마케팅 효과를 높일 수 있습니다. 마케팅 팀과 함께 구매 그룹을 만들기 전에 주요 구성 요소를 정의해야 합니다. 이들 구성 요소는 비즈니스 목표와 목적을 달성하는 데 중요합니다.
...
1. 관련 솔루션 관심 분야를 통해 계정 여정에 활용합니다.
...
| --- | --- | --- | --- | --- |
| 이벤트 등록 | 캠페인과 관련된 이벤트에 등록함 | 이벤트 | 20 | 60 |
| 이벤트 참여 | 캠페인 이벤트에 참여함 | 이벤트 | 20 | 90 |
| 이메일 열람 | 이메일을 열람함 | 이메일 | 20 | 30 |
| 이메일 클릭 | 이메일의 링크를 클릭함 | 이메일 | 20 | 30 |
| 판매 이메일 열람 | 판매 이메일을 열람함 | 이메일 | 20 | 30 |
| 판매 이메일 클릭 | 판매 이메일의 링크를 클릭함 | 이메일 | 20 | 30 |
| 즐거운 순간 | “즐거운 순간”이 있음 | 선별 | 20 | 60 |
| 푸시 알림 탭 | 푸시 알림을 수신함 | 모바일 | 20 | 30 |
| 모바일 앱 활동 | 모바일 앱에서 활동을 수행함 | 모바일 | 20 | 30 |
| 모바일 앱 세션 | 모바일 앱 세션에서 활성 상태임 | 모바일 | 20 | 30 |
| Facebook 리드 광고 양식 작성 | Facebook 페이지에서 리드 광고 양식을 작성하여 제출함 | 소셜 | 20 | 30 |
| RTP 콜 투 액션 클릭 | 개인화된 콜 투 액션을 클릭함 | 웹 | 20 | 60 |
| 인앱 메시지 확인 | 인앱 메시지를 확인함 | 모바일 | 20 | 30 |
| 인앱 메시지 탭 | 인앱 메시지를 탭함 | 모바일 | 20 | 30 |
| SMS 구독 | SMS 커뮤니케이션을 구독함 | SMS | 20 | 90 |
| 판매 이메일에 회신 | 판매 이메일에 회신함 | 이메일 | 20 | 30 |
| 대화에 참여함 | Dynamic Chat 대화에 참여함 | 채팅 | 20 | 90 |
| 대화에서 문서와 상호 작용함 | Dynamic Chat 대화에서 문서와 상호 작용함 | 채팅 | 20 | 90 |
| 대화에서 회의를 예약함 | Dynamic Chat 대화에서 일정을 예약함 | 채팅 | 20 | 90 |
| 대화 목표를 달성함 | Dynamic Chat 대화에서 목표를 달성함 |  | 20 | 90 |
| 웨비나에서 폴에 응답함 | 웨비나 이벤트에서 폴에 응답함 | 채팅 | 20 | 90 |
| 웨비나에서 콜 투 액션을 클릭함 | 웨비나 이벤트에서 콜 투 액션 링크를 클릭함 | 콜 | 20 | 30 |
| 웨비나에서 자산 다운로드 | 웨비나 이벤트에서 파일/자산을 다운로드함 | 이벤트 | 20 | 60 |
| 웨비나에서 질문을 함 | 웨비나 이벤트에서 질문을 함 | 이벤트 | 20 | 60 |
| 이벤트에 참여함 | 이벤트에 참여함 | 이벤트 | 20 | 60 |
| 대화에서 상담원과 상호 작용함 | Dynamic Chat 대화에서 상담원과 상호 작용함 | 채팅 | 20 | 90 |
| 대화에서 채팅의 링크를 클릭함 | Dynamic Chat 대화에서 링크를 클릭함 | 채팅 | 20 | 90 |
| 대화 플로우에 참여함 | Dynamic Chat 대화 플로우에 참여함 | 채팅 | 20 | 90 |
| 대화 플로우에서 회의를 예약함 | Dynamic Chat 대화 플로우에서 일정을 예약함 | 채팅 | 20 | 90 |
| 대화 플로우 목표를 달성함 | Dynamic Chat 대화 플로우에서 목표를 달성함 | 채팅 | 20 | 90 |
| 대화 플로우에서 문서와 상호 작용함 | Dynamic Chat 대화 플로우에서 문서와 상호 작용함 | 채팅 | 20 | 90 |
| 대화 플로우에서 상담원과 상호 작용함 | Dynamic Chat 대화 플로우에서 상담원과 상호 작용함 | 채팅 | 20 | 90 |
| 대화 플로우에서 채팅의 링크를 클릭함 | Dynamic Chat 대화 플로우에서 링크를 클릭함 | 채팅 | 20 | 90 |
| SMS V2의 링크 클릭 | SMS 메시지의 링크를 클릭함 | SMS | 20 | 90 |

>[!NOTE]
>
>참여 점수 활동은 Marketo Engage [활동 로그에 개인별로 기록됩니다](https://experienceleague.adobe.com/ko/docs/ marketo/using/product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/locate-the-activity-log-for-a-person){target="_blank"}.
