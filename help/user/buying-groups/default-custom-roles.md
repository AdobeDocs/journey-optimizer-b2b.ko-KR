...
역할 이름 및 설명을 편집하고 역할 목록에서 역할을 제거하는 등의 _[!UICONTROL 역할]_ 탭에서 사용자 지정 역할을 관리할 수 있습니다. _자세히_ 메뉴 아이콘(**...**)을 클릭합니다. 단계 모델 이름 옆에 있는 **[!UICONTROL 편집]** 또는 **[!UICONTROL 삭제]**&#x200B;를 선택합니다.
