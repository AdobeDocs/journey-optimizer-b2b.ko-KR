...
제품 질문을 하려면 패널 하단의 필드에 질문을 입력하고 Enter 키를 누릅니다. 예를 들어 여정에서 구매 그룹을 사용하는 방법을 배워야 하는 경우. 이 경우 _여정에서 구매 그룹을 어떻게 사용합니까?_&#x200B;를 입력하십시오. 질문을 제출하면 AI Assistant가 기술 자료를 쿼리하고 몇 초 만에 답변을 컴파일합니다.
