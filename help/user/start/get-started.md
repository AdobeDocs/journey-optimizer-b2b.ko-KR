...
description: 마케터를 위한 온보딩 안내서 - Journey Optimizer B2B edition에서 구매 그룹을 만들고 계정 여정을 디자인합니다.
role: User
level: Beginner
...
Adobe Journey Optimizer B2B edition에서 사용할 기능 및 도구는 팀 내에서 귀하의 역할에 따라 다릅니다. 조직에 따라 관리자는 여러 유형의 사용자를 정의하고 권한에 따라 특정 기능에 대한 액세스 권한을 부여할 수 있습니다.

관리자가 [설정 작업](../setup-ultimate.md)을 완료한 후 일반 사용자 온보딩에 이 정보를 사용하십시오.
...
1. **계정 대상자 추가**. Journey Optimizer B2B edition을 사용하면 애플리케이션에서 직접 세그먼트 정의를 통해 계정 대상을 만들고 계정 여정에서 활용할 수 있습니다. [자세히 알아보기](../audiences/account-audience-overview.md)
...
1. **자산 생성 및 관리**. Adobe Experience Manager Assets은 메시지에 사용할 수 있는 자산의 중앙 집중식 단일 저장소를 제공합니다. [자세히 알아보기](../content/assets-overview.md)

1. **개인화된 동적 전자 메일 템플릿 추가**. Journey Optimizer B2B Edition 개인화 및 다이내믹 콘텐츠 기능을 활용하여 메시지를 대상자에 맞게 조정하십시오. [자세히 알아보기](../content/email-templates.md)
