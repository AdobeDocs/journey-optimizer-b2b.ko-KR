---
title: Forms 구성
description: 양식 사전 설정을 구성하는 방법을 알아봅니다.
...
* _[!UICONTROL B2B 채널 구성]_ > _[!UICONTROL Forms 사전 설정 게시]_ - 양식 사전 설정 구성을 게시하는 데 필요합니다.
...
1. 탐색 패널의 _[!UICONTROL 양식 설정]_&#x200B;에서 **[!UICONTROL 양식 사전 설정]**&#x200B;을 선택합니다.
   ...
   ![양식 구성에 액세스](./assets/config-channels-forms.png){width="800" zoomable="yes"}
...
1. _데이터 집합 선택_( ![데이터 집합 선택 아이콘](../assets/do-not-localize/icon-select-data.svg) ) 아이콘을 클릭하여 데이터 집합을 양식과 연결합니다.
   ...
   ![데이터 세트 선택 대화 상자](./assets/config-channel-forms-select-datasets.png){width="500" zoomable="yes"}
