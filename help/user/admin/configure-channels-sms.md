...
1. SMS API 자격 증명을 구성합니다.
   ...
   ![Sinch SMS API 자격 증명 구성](./assets/config-sms-api-sinch.png){width="600" zoomable="yes"}
...
1. SMS API 자격 증명을 구성합니다.
   ...
   ![Twilio SMS API 자격 증명 구성](./assets/config-sms-api-twilio.png){width="600" zoomable="yes"}
...
1. SMS API 자격 증명을 구성합니다.
   ...
   ![Infobip SMS API 자격 증명 구성](./assets/config-sms-api-infobip.png){width="600" zoomable="yes"}
