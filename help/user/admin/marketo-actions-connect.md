...
>abstract="제품 관리자는 외부 Marketo Engage 인스턴스에 대한 연결을 구성할 수 있으므로 여정 작업에 사용할 수 있습니다."

다음 작업을 완료하여 여정 작업과 함께 사용할 외부 Marketo Engage 인스턴스를 구성합니다.
...
1. 일치하는 개인 레코드에 작업을 적용하는 데 사용되는 업데이트 정책을 선택합니다.
   ...
   * **[!UICONTROL 일치하는 최신 레코드만 업데이트]**
   ...
   >[!NOTE]
   >
   >사람들은 오류가 발생하는 경우를 제외하고 일치 항목에 관계없이 여정을 진행합니다.
