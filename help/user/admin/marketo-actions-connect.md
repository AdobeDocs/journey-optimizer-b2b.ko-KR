...
>title="외부 Marketo Engage 연결"
>abstract="제품 관리자는 외부 Marketo Engage 인스턴스에 대한 연결을 구성할 수 있으므로 여정 액션에 사용할 수 있습니다."

여정 작업에 사용할 외부 Marketo Engage 인스턴스를 구성하려면 다음 작업을 완료하십시오.
...
![통합 세부 정보 추가](assets/integration-connection-details.png){width="800" zoomable="yes"}

1. Journey Optimizer B2B edition에서 **[!UICONTROL 관리]** > **[!UICONTROL 구성]**&#x200B;으로 이동합니다.
1. **[!UICONTROL 통합]** 탭을 선택합니다.
1. **[!UICONTROL 연결 만들기]**&#x200B;를 클릭합니다.
1. **[!UICONTROL 이름]**(필수) 및 **[!UICONTROL 설명]**(선택 사항)을 입력하십시오.
1. 일치하는 개인 레코드에 작업을 적용하는 데 사용되는 업데이트 정책을 선택합니다.

   연결된 Marketo Engage 인스턴스에 대해 작업이 실행되면 선택한 _정책 업데이트_&#x200B;는 통합 개인 프로필에 여러 식별자가 있는지 여부를 선택할 Marketo Engage의 개인 레코드를 결정합니다.

   * **[!UICONTROL 일치하는 모든 레코드 업데이트]**
   * **[!UICONTROL 가장 오래된 일치 레코드만 업데이트]**
   * **[!UICONTROL 일치하는 최신 레코드만 업데이트]**
...
마케터는 여정에서 Marketo Engage 작업을 사용할 때 연결 이름을 사용하여 노드를 구성합니다.
