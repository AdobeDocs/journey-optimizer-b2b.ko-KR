...
![채널 구성 - 랜딩 페이지 하위 도메인](./assets/config-channels-landing-pages-subdomains.png){width="800" zoomable="yes"}
...
1. 위임할 하위 도메인을 지정합니다.
   ...
   ![랜딩 페이지 하위 도메인 설정](./assets/config-channels-landing-pages-subdomain-setup.png){width="500" zoomable="yes"}
...
1. DNS 레코드가 도메인 호스팅 솔루션에 생성되었는지 확인합니다.
   ...
   ![DNS 레코드로 설정된 랜딩 페이지 하위 도메인](./assets/config-channels-landing-pages-subdomain-setup-dns.png){width="500" zoomable="yes"}
...
![채널 구성 - 랜딩 페이지 사전 설정](./assets/config-channels-landing-pages-presets.png){width="800" zoomable="yes"}
...
1. 랜딩 페이지 하위 도메인을 선택합니다.
   ...
   ![이름, 설명 및 하위 도메인이 있는 랜딩 페이지 사전 설정](./assets/config-channels-landing-pages-preset-create.png){width="500" zoomable="yes"}
...
1. **[!UICONTROL 랜딩 페이지 하위 도메인과 동일]** 옵션을 선택하여 **[!UICONTROL 추적 URL]**&#x200B;에 대한 랜딩 페이지 하위 도메인을 선택할 수 있습니다.<!-- [Learn more about tracking](../email/message-tracking.md) -->

   ![하위 도메인 설정이 있는 랜딩 페이지 사전 설정](./assets/config-channels-landing-pages-preset-subdomain-settings.png){width="500" zoomable="yes"}
...
1. **[!UICONTROL 제출]**&#x200B;을 클릭하여 랜딩 페이지 사전 설정 만들기를 확인합니다.
   ...
   랜딩 페이지 사전 설정이 만들어지면 목록에 _[!UICONTROL 활성]_ 상태로 표시되고 [랜딩 페이지 만들기](../content/landing-pages-create-publish.md#create-landing-page)에 사용할 준비가 되었습니다.
