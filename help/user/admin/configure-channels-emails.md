...
![AEP 권한 아이콘](../../assets/do-not-localize/icon_permissions-outline.svg) 이 단계를 수행하려면 Experience Platform에서 할당된 사용자 역할에 대해 다음 [권한이 필요합니다.](../admin/user-management.md#b2b-product-permissions):

* **[!UICONTROL B2B 채널 구성]** - `Manage B2B Channels`
* **[!UICONTROL Journey Optimizer 규칙]** - `View Frequency Rules` 및 `Manage Frequency Rules`
...
1. **[!UICONTROL 최대 한도]**&#x200B;를 설정합니다.
   ...
   값을 입력하거나 오른쪽의 _위쪽_ 또는 _아래쪽_ 화살표를 클릭하여 값을 늘리거나 줄이십시오.
