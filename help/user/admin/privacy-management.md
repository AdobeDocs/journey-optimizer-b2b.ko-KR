...
다음 두 가지 방법으로 [!DNL Adobe Journey Optimizer B2B Edition]에서 소비자 데이터에 액세스하고 삭제하도록 개별 요청을 제출할 수 있습니다.
...
[!DNL Journey Optimizer B2B Edition] 개인 정보 보호 도구를 사용하면 [!DNL Privacy Service]을(를) 통해 규정을 준수할 수 있습니다. 각 규정은 연결된 지역에 거주하는 사람에 대한 데이터를 보유하고 있는 경우 적용됩니다.
...
[!DNL Journey Optimizer B2B Edition]은(는) 두 가지 개인 정보 보호 요청 유형을 지원합니다.
...
![권한 아이콘](../assets/do-not-localize/icon_permissions-outline.svg) 이 단계를 수행하려면 [!DNL Privacy Service] 제품 프로필과 Experience Platform에서 할당된 사용자 역할에 대한 다음 [권한이 필요합니다](./user-management.md).
...
[!DNL Journey Optimizer B2B Edition]에서 개인 정보 보호 요청 작업을 보려면 **[!UICONTROL 개인 정보 보호]**&#x200B;를 확장하고 **[!UICONTROL 요청]**&#x200B;을 선택하십시오.
...
1. **[!UICONTROL 요청 만들기]**&#x200B;를 선택합니다.

1. **[!UICONTROL 작업 유형]**&#x200B;에 대해 요청 유형을 선택하십시오.

   * **[!UICONTROL 액세스]**

     [!DNL Journey Optimizer B2B Edition]이(가) 포함된 **_액세스_** 요청을 제출하면 [!DNL Privacy Service]이(가) 다음을 반환합니다.

     * [!DNL Marketo Engage] 활동이 잠재 고객과 연결되었습니다.
     * 개인 또는 계정과 연결된 [!DNL Journey Optimizer B2B Edition] 활동.

   * **[!UICONTROL 삭제]**

     [!DNL Marketo Engage] 및 [!DNL Journey Optimizer B2B Edition]에 대해 **삭제** 요청을 제출하면 다음 레코드가 제거됩니다.

     * [!DNL Marketo Engage]에 연결된 잠재 고객.
     * [!DNL Journey Optimizer B2B Edition]에서 만들어진 개인 및 계정 레코드.
     * 개인의 개인 정보를 참조하는 AI 어시스턴트 대화 내역.
...
1. 요청을 제출하려면 **[!UICONTROL 만들기]**&#x200B;를 선택하세요.
...
| `include` | [!DNL Journey Optimizer B2B Edition]과(와) [!DNL Marketo Engage] 데이터를 모두 포함하는 `marketo` |
...
다음 예제에서는 [!DNL Journey Optimizer B2B Edition] 데이터를 포함하는 GDPR 삭제 요청을 제출합니다.
