...
XDM을 이해하고 데이터 엔지니어 또는 B2B 고객 데이터 플랫폼(CDP) 데이터 모델링 이해 당사자와 공동 작업하는 관리자는 다음 단계를 사용하여 [!DNL Journey Optimizer B2B Edition]에 대한 XDM 필드를 구성합니다.
...
>[!NOTE]
>
>이 기능은 현재 계정 관련 및 사용자 관련 사용자 지정 개체 사용 사례를 지원하며, 향후 더 많은 표준 개체 사용 사례를 지원할 계획입니다.
