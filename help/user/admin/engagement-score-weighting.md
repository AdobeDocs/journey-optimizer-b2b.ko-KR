...
+++Experience Platform 이벤트 활동

Experience Platform 이벤트에 대한 기본 모델에는 Experience Platform 추적 활동이 포함됩니다. 각 활동에는 가중치를 할당할 때까지 영(0) 가중치(사용되지 않음)가 있습니다. 또한 모든 활동의 최대 일일 빈도는 20이며, 변경할 수 없습니다.
