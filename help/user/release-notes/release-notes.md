...
| 개선 사항 | (Beta) 콘텐츠 개인화 - 개인 사용자 지정 개체 지원 | 사용자 지정 개체를 사용하여 콘텐츠 개인화를 정의하면 모델 기반 클래스의 사용자 지정 개체(관계형 스키마)에 대한 변수에 액세스할 수 있습니다. [자세히 알아보기](../content/personalization.md#custom-datasets) |
