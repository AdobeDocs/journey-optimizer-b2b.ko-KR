...
자격, 성능 보호 및 제한 사항에 대한 자세한 내용은 [제품 설명](https://helpx.adobe.com/kr/legal/product-descriptions/adobe-journey-optimizer-b2b.html){target="_blank"}을 검토하십시오.
...
| 유형 | 항목 | 설명 |
| ---- | ---- | ----------- |
| 기능 | 중복 계정 여정 | 이제 계정 여정에 대해 중복 작업을 사용할 수 있습니다. 계정 여정에 대한 세부 정보를 복제하거나 플로우 및 경로 구조의 간단한 뼈대를 복제할 수 있습니다. <a href="../journeys/journey-overview.md#duplicate-journey">자세히 알아보기</a> |
