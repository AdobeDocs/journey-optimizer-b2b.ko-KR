...
| 컨텍스트 | 액션 | 여정 유형 | 제한 |
| ------- | ------ | ------------ | ----------- |
| [Journey Optimizer B2B](#journey-optimizer-b2b-actions) | [!UICONTROL 외부 고객 대상에 추가] | <li>계정 여정 <li>사용자 여정 | <li>외부 고객 대상자 선택 |
...
| | [!UICONTROL 전자 메일 보내기] | <li>계정 여정 <li>사용자 여정 | <li>이메일 만들기 <li>전송 시간 최적화(선택 사항, 개인 여정 전용) |
| | [!UICONTROL SMS 보내기] | <li>계정 여정 | <li>SMS 만들기 |
| | [!UICONTROL WhatsApp 보내기] | <li>계정 여정 | <li>WhatsApp 메시지 만들기 |
| | [!UICONTROL 개인 프로필 업데이트] | <li>계정 여정 <li>사용자 여정 | <li>개인 속성 선택 <li>새 값 설정 |
| [Marketo Engage](#marketo-engage-actions) | [!UICONTROL Marketo 요청 캠페인에 추가] | <li>계정 여정 <li>사용자 여정 | <li>Marketo Engage 작업 영역 선택 <li>요청 캠페인 선택 |
