...
| 컨텍스트 | 액션 | 여정 유형 | 제한 |
| ------- | ------ | ------------ | ----------- |
| [Journey Optimizer B2B](#journey-optimizer-b2b-actions) | [!UICONTROL 외부 고객 대상에 추가] | <li>계정 여정 <li>개인 여정 | <li>외부 고객 대상자 선택 |
| | [!UICONTROL 구매 그룹에 할당] | <li>계정 여정 | <li>솔루션 관심 분야 선택 <li>역할 선택 |
| | [!UICONTROL 점수 변경] | <li>계정 여정 | <li>점수 이름 <li>점수 변경 |
| | [!UICONTROL 즐거운 인물] | <li>계정 여정 <li>개인 여정 | <li>유형 <li>설명 |
| | [!UICONTROL 웹 경험 개인화]&#x200B;(Beta) | <li>계정 여정 | <li>웹 경험 만들기/편집 |
| | [!UICONTROL 구매 그룹에서 제거] | <li>계정 여정 | <li>솔루션 관심 분야 선택 |
| | [!UICONTROL 전자 메일 보내기] | <li>계정 여정 <li>개인 여정 | <li>이메일 만들기 <li>전송 시간 최적화(선택 사항, 개인 여정 전용) |
| | [!UICONTROL SMS 보내기] | <li>계정 여정 | <li>SMS 만들기 |
| | [!UICONTROL WhatsApp 보내기] | <li>계정 여정 | <li>WhatsApp 메시지 만들기 |
| | [!UICONTROL 개인 프로필 업데이트] | <li>계정 여정 <li>개인 여정 | <li>개인 속성 선택 <li>새 값 설정 |
| [Marketo Engage](#marketo-engage-actions) | [!UICONTROL Marketo 요청 캠페인에 추가] | <li>계정 여정 <li>개인 여정 | <li>Marketo Engage 작업 영역 선택 <li>요청 캠페인 선택 |
| | [!UICONTROL Marketo 목록에 추가] | <li>계정 여정 <li>개인 여정 | <li>외부 Marketo 연결 이름 <li>목록 이름 |
| | [!UICONTROL Marketo 목록에서 제거] | <li>계정 여정 <li>개인 여정 | <li>외부 Marketo 연결 이름 <li>목록 이름 |

>[!NOTE]
>
>_[!UICONTROL Marketo Engage에서 사람 파티션 변경]_ 및 _[!UICONTROL 점수 변경]_ 작업은 2025.10 릴리스에서 더 이상 사용되지 않으며 Journey Optimizer B2B edition의 [간소화된 아키텍처](../simplified-architecture.md)에서 사용할 수 없습니다.<br/>
>
...
개인 여정의 경우 [전송 시간 최적화](../content/email-send-time-optimization.md)를 사용하여 각 프로필이 참여할 가능성이 가장 높은 시기를 예측하여 이메일 게재 시기를 개인화할 수 있습니다.
...
![작업 수행 - WhatsApp 보내기](./assets/node-action-send-whatsapp.png){width="300"}
...
>[!NOTE]
>
>_[!UICONTROL 사용자 프로필 업데이트]_&#x200B;가 [간소화된 아키텍처](../simplified-architecture.md)에서 _[!UICONTROL 데이터 값 변경]_ 작업을 대체합니다.<br/>
>
