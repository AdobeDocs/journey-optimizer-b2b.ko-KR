...
여정에서 _[!UICONTROL 작업 수행]_ 노드를 추가하여 전자 메일 보내기, 점수 변경, 구매 그룹에 할당 등의 작업을 실행할 수 있습니다. 작업은 일반적으로 이벤트나 이전 작업과 같은 일종의 트리거 결과로 발생하려는 작업입니다.

![비디오](../../assets/do-not-localize/icon-video.svg){width="30"} [개요 비디오 보기](#overview-video)

## 계정 작업

계정 여정에서 노드 경로에 있는 계정의 일부인 모든 사람에게 변경 사항을 적용하려면 계정에 대한 작업을 사용하십시오.
...
>[!NOTE]
>
>_[!UICONTROL 계정 변경 데이터 값]_ 작업은 2025.10 릴리스에서 더 이상 사용되지 않습니다. _[!UICONTROL 계정 프로필 업데이트]_&#x200B;가 [간소화된 아키텍처](../simplified-architecture.md)에 대해 이 작업을 대체합니다.<br/>
>
>관리자는 _[!UICONTROL XDM 클래스]_ > _[!UICONTROL 표준 클래스]_&#x200B;의 필드를 업데이트하여 XDM 비즈니스 계정에 사용할 수 있는 특성을 구성할 수 있습니다. 자세한 내용은 [표준 클래스](../admin/xdm-field-management.md#standard-classes)를 참조하세요.
...
계정 또는 사용자 여정에서 노드 경로의 모든 사용자에게 변경 사항을 적용하려면 사용자에 대한 작업을 사용하십시오. 계정 여정의 경우 이 노드 유형은 _사용자별 분할 경로_ 또는 _계정별 분할 경로_ 내에서 사용할 수 있습니다.

### 작업 및 제한 {#people-action-constraints}

| 컨텍스트 | 여정 유형 | 액션 | 제한 |
| ------- | ------------ | ------ | ----------- |
| [Journey Optimizer B2B](#journey-optimizer-b2b-actions) | <li>계정 여정 <li>개인 여정 | [!UICONTROL 외부 고객 대상에 추가] | <li>외부 고객 대상자 선택 |
| | <li>계정 여정 | [!UICONTROL 구매 그룹에 할당] | <li>솔루션 관심 분야 선택 <li>역할 선택 |
| | <li>계정 여정 | [!UICONTROL 점수 변경] | 점수 이름 <li>점수 변경 |
| | <li>계정 여정 <li>개인 여정 | [!UICONTROL 즐거운 인물] | <li>유형 <li>설명 |
| | <li>계정 여정 | [!UICONTROL 웹 경험 개인화]&#x200B;(Beta) | <li>웹 경험 만들기/편집 |
| | <li>계정 여정 | [!UICONTROL 구매 그룹에서 제거] | <li>솔루션 관심 분야 선택 |
| | <li>계정 여정 <li>개인 여정 | [!UICONTROL 전자 메일 보내기] | <li>이메일 만들기 |
| | <li>계정 여정 | [!UICONTROL SMS 보내기] | <li>SMS 만들기 |
| | <li>계정 여정 <li>개인 여정 | [!UICONTROL 개인 프로필 업데이트] | <li>개인 속성 선택 <li>새 값 설정 |
| [Marketo Engage](#marketo-engage-actions) | <li>계정 여정 <li>개인 여정 | [!UICONTROL Marketo Engage 요청 캠페인에 추가] | <li>Marketo Engage 작업 영역 선택 <li>요청 캠페인 선택 |
| | [!UICONTROL Marketo 목록에 추가] | <li>계정 여정 <li>개인 여정 | <li>외부 Marketo 연결 이름 <li>목록 이름 |
| | [!UICONTROL Marketo 목록에서 제거] | 계정 여정 <li>개인 여정 | <li>외부 Marketo 연결 이름 <li>목록 이름 |

>[!NOTE]
>
>_[!UICONTROL Marketo Engage에서 사용자 파티션 변경]_ 작업은 2025.10 릴리스에서 더 이상 사용되지 않으며 Journey Optimizer B2B edition의 [간소화된 아키텍처](../simplified-architecture.md)에서 사용할 수 없습니다.<br/>
>
>_[!UICONTROL 데이터 값 변경]_ 작업은 2025.10 릴리스에서 더 이상 사용되지 않습니다. 간소화된 아키텍처에서 _[!UICONTROL 개인 프로필 업데이트]_(으)로 대체되었습니다.
...
이 작업을 사용하여 구매 그룹의 구성원을 추가로 타겟팅하기 위해 유료 미디어 채널에서 활성화할 수 있는 외부 대상자로 사람들을 푸시할 수 있습니다. 이 작업은 Real-Time CDP B2B edition을 통해 실행됩니다.
...
2025.10 릴리스부터 [!DNL Experience Platform]에서 만든 외부 대상(예: [!DNL Adobe Target] 대상)을 통해 오케스트레이션할 수도 있습니다. 이 대상자 통합에 대한 자세한 내용은 [Adobe Target 외부 대상자](../audiences/target-external-audience.md)를 참조하십시오.
...
+++[!UICONTROL 웹 경험 개인화]&#x200B;(Beta)

이 동작을 사용하여 웹 사이트에서 직접 [개인화된 경험을 만들기](../content/web-experiences.md)하세요. 웹 채널 기능은 맞춤형 웹 컨텐츠와의 참여를 향상시키는 데 사용할 수 있는 유연한 툴킷을 제공합니다.

![작업 수행 - 웹 경험 개인화](./assets/node-action-person-personalize-web-experience.png){width="300"}
...
>[!NOTE]
>
>계정 여정에서 이메일 중복 제거를 사용하여 동일한 이메일이 여정 내의 동일한 이메일 주소로 여러 번 전송되지 않도록 할 수 있습니다. 자세한 내용은 [전자 메일 중복 제거](../content/email-deduplication.md)를 참조하십시오.
...
+++[!UICONTROL 개인 프로필 업데이트]

이 작업을 사용하여 [사람 프로필 특성](../admin/field-mapping.md#xdm-business-person-attributes)의 값을 변경합니다. 속성을 선택한 다음 새 값을 설정합니다.

![동작 수행 - 사용자 프로필 업데이트](./assets/node-action-update-person-profile.png){width="300"}

>[!NOTE]
>
>_[!UICONTROL 사용자 프로필 업데이트]_&#x200B;가 _[!UICONTROL 간소화된 아키텍처]_&#x200B;에서 [데이터 값 변경](../simplified-architecture.md) 작업을 대체합니다.<br/>
>
>관리자는 _[!UICONTROL XDM 클래스]_ > [!UICONTROL 표준 클래스]의 필드를 업데이트하여 XDM 개별 프로필에 사용할 수 있는 특성을 구성할 수 있습니다. 자세한 내용은 [표준 클래스](../admin/xdm-field-management.md#standard-classes)를 참조하세요.
