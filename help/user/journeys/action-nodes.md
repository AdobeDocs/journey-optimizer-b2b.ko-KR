...
1. (_계정 여정 전용_) 오른쪽의 노드 속성에서 작업 컨텍스트로 **[!UICONTROL 사람]**&#x200B;을(를) 선택합니다.
...
+++[!UICONTROL 다른 여정에 사용자 추가]

이 작업을 사용하여 실시간 개인 여정에 개인 프로필을 추가합니다. 개인이 작업 여정에 들어오면 지정된 개인 노드에 대한 대상 멤버로 추가됩니다.

**[!UICONTROL 라이브 사용자 여정 선택]** 선택기를 사용하여 사용자 여정을 추가할 사용자 프로필을 지정합니다. 필드에 텍스트를 입력하여 목록을 필터링할 수 있습니다.

![작업 수행 - (다른) 여정에 사용자 추가](./assets/node-action-add-to-person-journey.png){width="300"}

+++

+++[!UICONTROL 외부 고객 대상에 추가]

이 작업을 사용하여 구매 그룹의 구성원을 더 자세히 타겟팅하기 위해 유료 미디어 채널에서 활성화할 수 있는 외부 대상자로 사람들을 푸시할 수 있습니다. 이 작업은 Real-Time CDP B2B edition을 통해 실행됩니다.
...
이 작업을 사용하여 개인 프로필에서 개인 여정을 제거합니다. 개인이 작업 여정에 들어오면 지정된 개인 노드에 대한 대상 멤버로 제거됩니다.

**[!UICONTROL 개인 여정 선택]** 선택기를 사용하여 개인 여정을 제거할 개인 프로필을 지정합니다. 필드에 텍스트를 입력하여 목록을 필터링할 수 있습니다.

![작업 수행 - 여정에서 사용자 제거](./assets/node-action-remove-from-person-journey.png){width="300"}
