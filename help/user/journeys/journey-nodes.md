...
| | 구매 그룹 단계 업데이트 | 솔루션 관심 분야 선택<br/>구매 그룹 단계 선택 |
...
| 노드 컨텍스트 | 이벤트 | 제한 |
| ------------ | ----- | ----------- |
| [사람](#add-a-people-event) | 구매 그룹에 할당됨 | 솔루션 관심<br/>추가 제약 조건(선택 사항): <li>역할</li><li>활동 날짜</li><br/>시간 초과(선택 사항) |
| | 이메일의 링크 클릭 | 전자 메일<br/>추가 제한(선택 사항): <li>링크</li><li>링크 ID</li><li>모바일 디바이스임</li><li>디바이스</li><li>플랫폼</li><li>브라우저</li><li>예측 콘텐츠</li><li>보트 활동임</li><li>보트 활동 패턴</li><li>브라우저</li><li>활동 날짜</li><li>최소. 횟수</li><br/>시간 초과(선택 사항) |
| | SMS의 링크 클릭 | 전자 메일<br/>추가 제한(선택 사항): <li>링크</li><li>디바이스</li><li>플랫폼</li><li>활동 날짜</li><li>최소. 횟수</li><br/>시간 초과(선택 사항) |
| | 데이터 값 변경 | Person 특성<br/>추가 제약 조건(선택 사항): <li>새 값</li><li>이전 값</li><li>이유</li><li>소스</li><li>활동 날짜</li><li>최소. 횟수</li><br/>시간 초과(선택 사항) |
| | 이메일 열기 | 전자 메일<br/>추가 제한(선택 사항): <li>링크</li><li>링크 ID</li><li>모바일 디바이스임</li><li>디바이스</li><li>플랫폼</li><li>브라우저</li><li>예측 콘텐츠</li><li>보트 활동임</li><li>보트 활동 패턴</li><li>브라우저</li><li>활동 날짜</li><li>최소. 횟수</li><br/>시간 초과(선택 사항) |
| | 구매 그룹에서 제거됨 | 솔루션 관심 분야<br/>활동 날짜(선택 사항)<br/>시간 초과(선택 사항) |
| | 점수가 변경됨 | 점수 이름<br/>추가 제한(선택 사항):<li>변경</li><li>새 스코어</li><li>긴급도</li><li>우선순위</li><li>상대 스코어</li><li>상대 긴급도</li><li>활동 날짜</li><li>최소. 횟수</li><br/>시간 초과(선택 사항) |
| | SMS 바운스 | SMS 메시지<br/>추가 제약 조건(선택 사항): <li>활동 날짜</li><li>최소 횟수</li><br/>시간 초과(선택 사항) |
| [계정](#add-an-account-event) | 계정에는 흥미로운 순간이 있었습니다. | 형식(전자 메일, 마일스톤 또는 웹)<br/>추가 제한(선택 사항): <li>설명</li><li>소스</li><li>활동 날짜</li> <br/>시간 초과(선택 사항) |
...
* 사람 노드로 경로 분할은 그룹화된 노드입니다. 대상자에 있는 모든 사람이 계정 컨텍스트를 잃지 않고 다음 단계로 이동할 수 있도록 경로가 자동으로 병합됩니다.
* 사람에 대한 분할 경로는 중첩될 수 없으며, 이렇게 그룹화된 노드에 있는 경로에 사람에 대한 분할 경로를 추가할 수 없습니다.
* 분할 경로에는 기본 경로를 생략하는 옵션이 포함됩니다. 정의된 경로에 대해 일치 항목이 없는 계정/사람은 여정에서 앞으로 이동하지 않습니다.
* 사용자별 분할 경로는 _계정-사용자 관계_&#x200B;의 사용을 지원하며, 이를 통해 역할 템플릿에 정의된 대로 자신의 역할(예: 계약자 또는 상근 직원)을 기준으로 사용자를 필터링할 수 있습니다.
...
| 노드 컨텍스트 | 경로 조건 | 설명 |
| ------------ | --------------- | ----------- |
| [계정](#add-a-split-path-by-account-node) | 계정 속성 | 다음을 포함한 계정 프로필의 속성: <li>연간 수익</li><li>구/군/시</li><li>국가</li><li>직원 규모</li><li>업계</li><li>이름</li><li>SIC 코드</li><li>주/도</li> |
...
1. 정의된 경로와 일치하지 않는 계정의 기본 경로를 추가하려면 **[!UICONTROL 다른 계정]** 옵션을 활성화하십시오. 그렇지 않은 경우 이러한 사용자에 대한 여정이 종료됩니다.
...
1. 정의된 경로와 일치하지 않는 사람에 대한 기본 경로를 추가하려면 **[!UICONTROL 다른 사람]** 옵션을 활성화하십시오. 그렇지 않은 경우 이러한 사용자에 대한 여정이 종료됩니다.
