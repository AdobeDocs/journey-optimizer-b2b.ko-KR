...
이벤트 기반 개인 여정은 여전히 이메일 주소가 익명/없고 ECID만 포함된 프로필을 분류할 수 있습니다. 이 문제는 웹 페이지 활동에 대한 자격 논리가 있을 때 가장 일반적으로 발생합니다. 너무 광범위한 이벤트 기반 대상 논리는 너무 많은 프로필이 조건을 충족하면 인스턴스가 4천만 프로필 상한에 도달할 수 있습니다. 이 시나리오를 방지하려면 대상의 가능한 범위를 제한하십시오.
