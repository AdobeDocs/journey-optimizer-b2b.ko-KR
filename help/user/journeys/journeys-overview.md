...
여정 상태는 적용하는 액션에 따라 변경될 수 있습니다. 여정 상태에 따라 특정 작업은 헤더의 오른쪽에서 사용할 수 있거나 사용할 수 없습니다.
...
복제 액션은 복제 함수와 유사하지만 복제된 여정에는 생성된 여정 콘텐츠 자산이 포함되지 않습니다. 여정 또는 흐름 및 경로 구조의 간단한 _구조_&#x200B;에 대한 세부 정보를 복제할 수 있습니다.
...
1. _여정 복제_ 대화 상자에서 새로운 여정에 대한 **[!UICONTROL 이름]** 및 **[!UICONTROL 설명]**&#x200B;을 설정합니다.
   ...
   기본적으로 대화 상자는 __ copy_가 붙은 복제된 여정의 이름을 사용합니다. 필요한 경우 여정에 대한 다른 고유한 이름을 입력합니다.
...
1. _자세히_ 아이콘(**...**)을 클릭합니다. 여정 이름 옆에 있는 **[!UICONTROL 삭제]**&#x200B;를 선택합니다.
