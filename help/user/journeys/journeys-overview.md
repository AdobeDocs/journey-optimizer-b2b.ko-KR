...
진행 중인 여정을 마감하면 현재 여정에 있는 계정은 해당 여정에서 경로를 계속 이어가며 더 이상 여정에 진입할 수 없게 됩니다. 마감된 여정은 다시 시작할 수 없습니다. 마감된 여정을 복제할 수 있습니다.
...
_Live_, _새 항목으로 닫힘_, _중단됨_ 또는 _완료됨_ 상태의 게시된 계정 여정의 경우 여정 맵을 열어 여정 노드에 대한 계정 진행률을 검토하십시오. 맵의 각 노드에는 해당 노드에 도달한 계정 수가 표시되며, 라이브 여정의 경우 현재 해당 노드에 있는 계정 수가 표시됩니다.
