...
계정 여정에서 분할 및 병합 경로 노드를 사용하여 정의한 조건에 따라 사람 또는 계정을 세그먼트화합니다. 조건에 따라 여정 대상자 또는 계정 목록에 대한 경로를 정의하고, 각 세그먼트에 대한 작업 및 이벤트 노드를 사용하여 각 경로를 정의한 다음, 경로를 결합하고 여정을 계속 진행할 수 있습니다.
