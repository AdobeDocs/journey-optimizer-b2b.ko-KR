...
**경로 1 - 활성 제품 연구원**
*CRM 소프트웨어를 찾는 사람을 식별합니다. 지난 30일 동안 반복된 제품 페이지 방문, 비교 콘텐츠와의 참여, 빈번한 재방문 및 높아진 타사 의도 신호를 찾습니다.*
...
**경로 1 - 가격 책정 순서 조사**
*전자 책을 다운로드하고 7일 이내에 가격 페이지를 방문했지만 데모를 요청하지 않은 사용자를 식별합니다.*

**경로 2 - 후속 작업이 없는 웨비나**
*웨비나에 참석하고 제품 페이지로 돌아왔지만 데모를 예약하거나 판매에 연락하지 않은 사람을 식별합니다.*

**경로 3 - 비교 주도 평가**
*경쟁업체 비교 문서를 본 다음 14일 이내에 통합 또는 마이그레이션 설명서를 방문한 방문자를 식별합니다.*
...
**경로 1 - 특정 지역의 급증**
*지난 30일 동안 과거 기준선에 비해 향상된 제품 조사 활동 및 높아진 타사 의도 신호를 보여 주는 북미의 계정을 식별합니다.*

**경로 2 - 신흥 시장 모멘텀**
*전체 참여 볼륨이 여전히 중간 수준이더라도 APAC에서 참여 속도가 지난 14일 동안 크게 증가한 계정을 식별합니다.*

**경로 3 - 지역별 엔터프라이즈 관심 분야**
*지난 21일 동안 규정 준수, 데이터 상주 또는 보안 문서에 참여하는 EMEA의 엔터프라이즈 규모 계정을 식별합니다.*

**경로 4 - 언더스루 영역**
*인텐트 신호를 표시했지만 아직 연락하지 않은 지정된 판매 지역에서 높은 수준의 계정을 식별합니다.*

+++

+++웨비나 대상 타기팅

**경로 1 - AI에 관심이 있는 HR 리더**
*지난 30일 동안 Journey Optimizer에 관심이 있고 &quot;HR 작업의 AI&quot;에 대한 웨비나에 참석할 가능성이 있는 HR 사이트에 참여한 사람을 식별합니다(shrm.org, hbr.org/topic/human-resource-management). AI 제품에 대한 관심도 표시했어야 합니다.*

**경로 2 - AI에 관심이 있는 금융 전문가**
*지난 30일 동안 Marketo에 관심이 있고 &quot;Financial Planning의 AI&quot;에 대한 웨비나에 참석할 가능성이 있는 금융 사이트(wsj.com/finance, investopedia.com)에 참여한 사람을 식별합니다. AI 제품에 대한 관심도 표시했어야 합니다.*

**경로 3 - AI에 관심이 있는 위험 및 연구 전문가**
*지난 30일 동안 GenStudio에 관심이 있고 &quot;위험 관리의 AI&quot;에 대한 웨비나에 참석할 가능성이 있는 위험/연구 사이트(mckinsey.com/capabilities/risk-and-resilience, forrester.com/research)에 참여한 사람을 식별합니다. AI 제품에 대한 관심도 표시했어야 합니다.*
...
2. [여정을 게시합니다](./journeys-overview.md).

여정이 라이브되면 그 다음으로 좋은 경로 노드가 실행 시 실행됩니다. 각 사람이 노드에 도달하면 AI가 최신 신호를 이용해 실시간으로 평가해 가장 관련성이 높은 경로로 라우팅한다.

게시된 여정의 경우 여정 맵을 열고 다음 최상의 경로 노드를 선택하여 오른쪽 패널에서 **_[!UICONTROL 라이브 결과]_** 섹션을 보십시오. 라이브 결과는 다음과 같습니다.
