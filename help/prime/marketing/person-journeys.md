...
* [!UICONTROL 이름]&#x200B;(편집할 여정 맵을 열려면 이름을 클릭하십시오.)
* [!UICONTROL 상태]
* [!UICONTROL 만든 날짜]
* [!UICONTROL 생성자]
* [!UICONTROL 마지막 업데이트]
...
각 여정 맵의 헤더에는 여정 이름, 상태 및 일정이 포함됩니다.
...
* 여정 작업을 적용하거나 트래픽 제어 및 다시 시작을 활성화/비활성화하려면 **[!UICONTROL 자세히]**&#x200B;를 클릭하십시오.
* 모든 오류가 해결되고 여정을 활성화하려면 **[!UICONTROL 게시]**&#x200B;를 클릭합니다.

### 여정 디자인 {#journey-design}

_여정 맵_&#x200B;은(는) 여정 작업 영역의 중앙 영역입니다. 여기에서 여정 노드를 추가하고 구성할 수 있습니다. 노드를 클릭하여 패널에서 레이아웃 오른쪽에 있는 속성을 열고 디자인에 따라 설정합니다. 개인 여정은 항상 [_[!UICONTROL 개인 대상&#x200B;]_&#x200B;노드](./person-audience-node.md)(으)로 시작하며, 여기서 여정에 대한 입력을 정의할 수 있습니다.

개인 여정을 만들고 개인 대상자를 정의한 후 노드를 사용하여 여정을 빌드합니다. 여정 맵은 여정을 구성하기 위해 다음 노드 유형을 사용하여 다단계 B2B 마케팅 사용 사례를 구축할 수 있는 캔버스를 제공합니다.
...
1. 필요한 경우 여정의 **[!UICONTROL 종료 날짜]**&#x200B;를 지정하십시오.
   ...
   ![여정 설정 검토 대화 상자](./assets/journey-settings.png){width="400" zoomable="no"}
...
1. _[!UICONTROL 개인 여정]_ 목록에서 여정 이름 옆의 _자세히_ 아이콘(**...**)을 클릭하고 **[!UICONTROL 삭제]**&#x200B;를 선택합니다.
   ...
   * 초안 여정의 경우 오른쪽 상단의 **[!UICONTROL 자세히...]**&#x200B;를 클릭하고 **[!UICONTROL 삭제]**&#x200B;를 선택하십시오.
