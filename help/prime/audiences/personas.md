...
* _Sales Qualifier 컨텍스트_ - BDR(비즈니스 개발 담당자)은 구매자 여정에서 개인의 신원, 관심사 및 현재 상태를 보여주는 화면 요약을 받습니다
...
[!DNL Journey Optimizer B2B Prime]은(는) 정의된 담당자에 대해 레코드 특성을 평가하여 각 개인 레코드에 대한 담당자를 파생합니다. 사용자 목록에 대한 대상자를 정의하거나 사용자 여정에서 세그먼트화할 때 추론된 결과(_파생된 사용자_)를 필터로 사용할 수 있습니다.
