...
|---|---|---|---|---|
| `falco-program-creation` | 프로그램, 하위 폴더, 토큰, 목록, 여정 등 전체 [!DNL Journey Optimizer B2B Prime] 프로그램 만들기. | 쓰기 | [!DNL Journey Optimizer B2B Prime] | 읽기 + 쓰기 [!DNL Journey Optimizer B2B Prime] |
...
| 스킬 | 기능 | 액세스 | 제품 | 백엔드(데이터 흐름) |
|---|---|---|---|---|
| `audience-creation` | [!DNL Marketo Engage] 스마트 목록을 조정하거나 사람 목록을 만들거나 규칙을 추가/업데이트합니다. | 쓰기 | [!DNL Journey Optimizer B2B Prime] | 읽기 [!DNL Marketo Engage] + 읽기/쓰기 [!DNL Journey Optimizer B2B Prime] |
...
| 스킬 | 기능 | 액세스 | 제품 | 백엔드(데이터 흐름) |
|---|---|---|---|---|
| `scoring-studio` | 채점 모델을 나열/가져오고 빌드/게시합니다. | 읽기+쓰기 | [!DNL Journey Optimizer B2B Prime] | 읽기 + 쓰기 [!DNL Journey Optimizer B2B Prime]&#x200B;(채점 서비스), 읽기 선행 필드/활동 유형 [!DNL Marketo Engage]개 |
