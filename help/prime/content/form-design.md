---
title: 양식 디자인
description: Journey Optimizer B2B Prime의 비즈니스 데이터 수집을 위한 필드 유형, 유효성 검사, 스타일 지정 및 XDM 스키마 속성이 있는 디자인 양식입니다.
...
![양식 디자인 공간](../../user/content/assets/form-new-design-space.png){width="700" zoomable="yes"}
...
1. 왼쪽의 _[!UICONTROL 구성 요소]_ 패널에서 **[!UICONTROL 필드]** 콘텐츠 구성 요소를 드래그하여 캔버스에 놓습니다.
   ...
   ![양식에 필드 구성 요소 추가](../../user/content/assets/form-content-add-field.png){width="800" zoomable="yes"}
...
1. _[!UICONTROL 필드 특성 선택]_&#x200B;에 대해 옵션을 선택하고 필드에 대한 특성을 설정합니다.
   ...
   * **[!UICONTROL 필드 특성 선택]** - 이 옵션을 사용하여 양식에 대한 사전 설정에 정의된 데이터 집합 스키마를 기준으로 특성을 선택합니다.
     ...
     ![선택한 특성 필드 구성 요소를 양식에 추가](../../user/content/assets/form-field-select-attribute-filtered.png){width="700" zoomable="yes"}
   ...
   * **[!UICONTROL 사용자 지정 필드 추가]**
     ...
     ![양식에 사용자 지정 필드 구성 요소 추가](../../user/content/assets/form-field-add-custom-field.png){width="600" zoomable="yes"}
...
1. 필드의 데이터 형식에 따라 **[!UICONTROL 필드 형식]**&#x200B;을(를) 설정합니다.
   ...
   | **[!UICONTROL 통화]** | [!DNL Journey Optimizer B2B Prime] 인스턴스에 대해 선택한 기본 통화 유형을 나타내는 부동 소수점 필드를 허용하려면 이 유형을 사용하십시오. |
...
1. 선택한 필드 유형에 따라 필드 항목 및 유효성 검사에 대한 다른 옵션을 설정합니다.
   ...
   ![선택한 필드 유형에 따라 필드에 대한 옵션을 설정합니다](../../user/content/assets/form-field-details-text-type.png){width="800" zoomable="yes"}
...
1. 필요에 따라 **[!UICONTROL 필드 동작]**&#x200B;을 설정합니다.
   ...
   * **[!UICONTROL 입력 마스크 사용]** - 입력 마스크를 사용하여 방문자의 입력을 제한하려면 확인란을 선택합니다. 예를 들어 방문자가 특정 형식의 전화 번호를 입력하도록 할 수 있습니다. 대화 상자에서 임의의 숫자에 대해 `9`, 임의의 문자에 대해 `a`, 둘 중 하나에 대해 `*`을 사용하여 마스크를 입력합니다.
     ...
     ![필드에 대한 입력 마스크 정의](../../user/content/assets/form-field-mask-input-dialog.png){width="550" zoomable="yes"}
...
* **[!UICONTROL 배경]** - 필드에 배경색을 적용하려면 확인란을 선택하십시오. 흰색이 기본 색상입니다. **[!UICONTROL 배경색]** 사각형을 클릭하여 팝업 색상 선택기를 열고 필드 배경색을 선택합니다.
  ...
  ![양식 필드의 배경 스타일을 설정합니다](../../user/content/assets/form-field-styles-background-color.png){width="600" zoomable="yes"}
...
* **[!UICONTROL 레이블]** - 레이블 스타일이 필드 옆에 표시되는 텍스트의 시각적 특성을 제어합니다. 필드를 기준으로 상단 또는 측면 레이블 표시를 선택합니다. 글꼴 크기, 선 높이, 텍스트 스타일 및 텍스트 정렬을 설정할 수 있습니다. **[!UICONTROL 글꼴 색상]** 사각형을 클릭하여 팝업 색상 선택기를 열고 레이블 텍스트의 색상을 선택합니다.
  ...
  ![양식 필드에 대한 레이블 스타일을 설정합니다](../../user/content/assets/form-field-styles-label.png){width="600" zoomable="yes"}
...
* **[!UICONTROL 테두리]** - **[!UICONTROL 테두리 색상]** 사각형을 클릭하여 팝업 색상 선택기를 열고 테두리 색상을 선택합니다. 색상 및 선 너비를 포함하여 필드에 대한 테두리를 정의할 수 있습니다. 표시된 필드 테두리를 제거하려면 확인란의 선택을 취소하십시오. 모퉁이에 대한 테두리 크기(픽셀 너비), 스타일 및 반경 설정을 변경할 수도 있습니다.
  ...
  ![양식 필드의 테두리 스타일 설정](../../user/content/assets/form-field-styles-border.png){width="600" zoomable="yes"}
...
* **[!UICONTROL 패딩]** - 필드 주위에 패딩을 설정합니다(픽셀 단위). 4개의 모든 면에 동일한 패딩을 설정하거나 **[!UICONTROL 각 면에 대해 다른 패딩]** 확인란을 선택하여 수평 및 수직 패딩을 별도로 설정할 수 있습니다.
  ...
  ![양식 필드의 크기, 여백 및 패딩 스타일을 설정합니다](../../user/content/assets/form-field-styles-size-margin-padding.png){width="600" zoomable="yes"}
...
![양식의 필드를 이동하고 그룹화 및 레이아웃에 구조적 구성 요소를 사용](../../user/content/assets/form-field-move-tool.png){width="500"}

### 필드 삭제 또는 복제 {#field-delete-duplicate}

선택한 필드를 삭제하려면 도구 모음 또는 오른쪽 패널에서 _삭제_ 아이콘( ![삭제 아이콘](../../user/assets/do-not-localize/icon-delete.svg) )을 클릭하십시오. 확인 대화 상자에서 **[!UICONTROL 삭제]**&#x200B;를 클릭합니다.

선택한 필드를 복제하려면 도구 모음 또는 오른쪽 패널에서 _복제_ 아이콘( ![복제 아이콘](../../user/assets/do-not-localize/icon-duplicate.svg) )을 클릭하십시오. 새 필드는 원래 필드 바로 아래에 표시됩니다. 필드의 특성을 설정하려면 **[!UICONTROL 필드 특성 선택]**&#x200B;을 클릭합니다. 필요에 따라 필드 유형, 세부 정보 및 스타일을 설정합니다.

![양식 필드에 대한 아이콘 삭제 및 복제](../../user/content/assets/form-field-delete-duplicate.png){width="600" zoomable="yes"}
...
![양식의 단추 텍스트 변경](../../user/content/assets/form-field-button-text.png){width="600" zoomable="yes"}
...
* **[!UICONTROL 배경]** - 단추의 배경색을 적용하려면 확인란을 선택하십시오. 기본값은 파란색입니다. **[!UICONTROL 배경색]** 사각형을 클릭하여 팝업 색상 선택기를 열고 단추 배경색을 선택합니다.
  ...
  ![양식 단추의 배경 스타일을 설정합니다](../../user/content/assets/form-button-styles-background-color.png){width="600" zoomable="yes"}
...
* **[!UICONTROL 크기]** - 단추의 표시 너비를 결정할 크기 설정을 선택합니다. _[!UICONTROL 전체 너비]_, _[!UICONTROL 절반 너비]_ 또는 _[!UICONTROL 자동]_&#x200B;을 선택하세요. 패딩은 크기와 정렬 설정에 따라 조정됩니다.
  ...
  ![양식 단추의 레이블, 테두리 및 크기 스타일을 설정합니다](../../user/content/assets/form-button-styles-label-border-size.png){width="600" zoomable="yes"}
...
* **[!UICONTROL 패딩]** - 단추 주위에 패딩을 설정합니다(픽셀 단위). 4개의 모든 면에 동일한 패딩을 설정하거나 **[!UICONTROL 각 면에 대해 다른 패딩]** 확인란을 선택하여 수평 및 수직 패딩을 별도로 설정할 수 있습니다. 크기와 정렬 설정을 변경하면 패딩이 조정됩니다.
  ...
  ![양식 단추의 맞춤, 여백 및 패딩 스타일 설정](../../user/content/assets/form-button-styles-alignment-margin-padding.png){width="600" zoomable="yes"}
...
![양식 본문의 최상위 스타일을 설정합니다](../../user/content/assets/form-body-styles.png){width="600" zoomable="yes"}
...
1. 오른쪽 패널에서 **[!UICONTROL CSS 보기]**&#x200B;를 클릭하여 CSS 코드를 검토합니다.
   ...
   ![양식에 대한 CSS 보기](../../user/content/assets/form-body-styles-view-css.png){width="450" zoomable="yes"}
...
1. CSS 코드를 창에 붙여넣습니다.
   ...
   ![양식에 대한 사용자 지정 CSS 추가](../../user/content/assets/form-body-styles-custom-css.png){width="450" zoomable="yes"}
...
* **[!UICONTROL 뷰포트 배경]** - 모든 양식 구성 요소에 배경색을 적용하려면 확인란을 선택하십시오. 기본값은 색상 없음(외부 배경에서 상속)입니다. 색상 사각형을 클릭하여 팝업 색상 선택기를 열고 양식 구조 구성 요소의 색상을 선택합니다.
  ...
  ![양식의 배경색 설정](../../user/content/assets/form-body-styles-background-colors.png){width="600" zoomable="yes"}
...
* **[!UICONTROL 여백]** - 양식 구성 요소 주위에 여백(픽셀 단위)을 설정합니다. 네 개의 면에 동일한 여백을 설정하거나 **[!UICONTROL 각 면에 대해 다른 여백]** 확인란을 선택하여 가로 및 세로 여백을 별도로 설정할 수 있습니다.
  ...
  ![양식의 텍스트, 크기 및 여백을 설정합니다](../../user/content/assets/form-body-styles-text-size-margin.png){width="600" zoomable="yes"}
