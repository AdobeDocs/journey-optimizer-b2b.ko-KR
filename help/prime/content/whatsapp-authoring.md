...
Journey Optimizer B2B Prime을 사용하여 모바일 디바이스를 사용하는 사람에게 WhatsApp 메시지를 보냅니다. WhatsApp 편집기에서 승인된 Meta 메시지 템플릿을 사용하여 메시지를 만들고, 개인화하고, 미리 볼 수 있습니다.
...
>[!NOTE]
>
>Journey Optimizer B2B Prime에서는 _아웃바운드_ WhatsApp 메시지 요소만 지원됩니다.
...
WhatsApp 메시지는 Meta WhatsApp 비즈니스 계정에서 사전 승인된 메시지 템플릿을 사용하여 전송됩니다. **Meta에서 템플릿을 검토하고 승인**&#x200B;해야 Journey Optimizer B2B Prime에서 사용할 수 있습니다. 승인을 위해 템플릿을 관리하고 제출하려면 [!DNL Meta Business Manager] 계정 관리자와 협력하십시오.
