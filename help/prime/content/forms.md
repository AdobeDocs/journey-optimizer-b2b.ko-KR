---
title: 양식
description: Journey Optimizer B2B Prime의 디자인 필드, 감사 페이지 설정, 게시 및 사용 추적 등 비즈니스 데이터 수집을 위한 재사용 가능한 양식을 만들고 관리합니다.
...
[!DNL Journey Optimizer B2B Prime]에서 양식에 액세스하려면 왼쪽 탐색으로 이동하여 **[!UICONTROL 콘텐츠 관리]** > **[!UICONTROL Forms]**&#x200B;을(를) 클릭하십시오. 이 작업을 수행하면 인스턴스에서 만든 모든 양식을 표시하는 목록 페이지가 열립니다.
...
![양식 상태 주기](../../user/content/assets/status-lifecycle-diagram.png){zoomable="yes"}

### 양식 목록 필터링 {#filter-list}

이름별로 양식을 검색하려면 검색 막대에 일치 항목 텍스트 문자열을 입력합니다. _필터_ 아이콘(![필터 표시 또는 숨기기 아이콘](../../user/assets/do-not-localize/icon-filter.svg) )을 클릭하여 사용 가능한 필터 옵션을 표시하고 설정을 변경하여 지정된 조건에 따라 표시된 항목을 필터링합니다.

![표시된 양식 필터링](../../user/content/assets/forms-list-filtered.png){width="700" zoomable="yes"}
...
![Forms 목록에 표시할 열](../../user/content/assets/forms-customize-table-dialog.png){width="300"}

## 양식 만들기 {#create-forms}

[!DNL Journey Optimizer B2B Prime]에서 재사용 가능한 양식을 만들기 전에 고려해야 할 몇 가지 사항이 있습니다.
...
1. _[!UICONTROL 양식 만들기]_ 대화 상자에서 유용한 **[!UICONTROL 이름]**(필수)과 **[!UICONTROL 설명]**(선택 사항)을 입력하십시오.
   ...
   * 예약된 문자가 **_허용되지 않음_**: `\ / : * ? " < > |`
   ...
   ![양식 대화 상자 만들기](../../user/content/assets/forms-create-dialog.png){width="400"}

1. **[!UICONTROL 사전 설정]**&#x200B;의 경우 _데이터 선택_( ![데이터 선택 아이콘](../../user/assets/do-not-localize/icon-select-data.svg) ) 아이콘을 클릭하여 구성된 양식 사전 설정을 양식과 연결합니다.
...
1. **[!UICONTROL 만들기]**&#x200B;를 클릭합니다.
   ...
   ![기본 양식 콘텐츠](../../user/content/assets/form-new-default-content.png){width="700" zoomable="yes"}
...
* **[!UICONTROL 랜딩 페이지]** - [!DNL Journey Optimizer B2B Prime] 랜딩 페이지를 후속 페이지로 선택하려면 이 옵션을 선택하십시오.
...
![양식 게시 대화 상자](../../user/content/assets/form-publish-dialog.png){width="400"}
...
![게시된 양식에 대한 세부 정보 보기](../../user/content/assets/form-details-published.png){width="600" zoomable="yes"}
...
오른쪽의 _[!UICONTROL 요약]_ 패널에서 **[!UICONTROL 사용자]** 탭을 클릭하여 랜딩 페이지 및 랜딩 페이지 템플릿에서 [!DNL Journey Optimizer B2B Prime] 내에서 현재 양식을 사용하는 위치에 대한 세부 정보를 볼 수 있습니다.

>[!IMPORTANT]
>
>현재 랜딩 페이지나 랜딩 페이지 템플릿에서 사용 중인 모든 양식은 삭제할 수 없습니다.

![양식의 참조에서 사용됨](../../user/content/assets/form-used-by-published.png){width="600" zoomable="yes"}
...
![양식 대화 상자 삭제](../../user/content/assets/form-delete-dialog.png){width="400"}

양식이 현재 사용 중인 경우 작업을 수행하면 양식을 삭제할 수 없음을 알리는 정보 대화 상자가 열립니다. **[!UICONTROL 확인]**&#x200B;을 클릭하여 삭제 작업을 중단합니다.

![양식 삭제 대화 상자 - 사용 중인 양식을 삭제할 수 없음](../../user/content/assets/form-delete-dialog-in-use.png){width="400"}
...
![양식 복제](../../user/content/assets/form-list-page-duplicate.png){width="450"}

대화 상자에서 유용한 이름(고유)과 설명을 입력합니다. 작업을 완료하려면 **[!UICONTROL 복제]**&#x200B;를 클릭하십시오.

![중복 양식의 이름 및 설명](../../user/content/assets/form-duplicate-dialog.png){width="400"}
...
1. 이름, 설명 등 세부 사항을 수정합니다.
   ...
   ![초안 상태의 양식에 대한 세부 정보](../../user/content/assets/form-details-draft.png){width="600" zoomable="yes"}
...
1. 대화 상자에서 **[!UICONTROL 초안 버전 만들기]**&#x200B;를 클릭하여 시각적 디자인 공간에서 초안 버전을 엽니다.
   ...
   ![초안 버전 만들기 대화 상자](../../user/content/assets/form-published-edit-create-draft-dialog.png){width="400"}
...
1. **[!UICONTROL 초안]** 탭을 선택합니다.
   ...
   ![양식 초안 버전 편집](../../user/content/assets/form-published-with-draft-edit.png){width="700" zoomable="yes"}
...
![선택한 양식에 작업 적용](../../user/content/assets/form-actions-page-authoring.png){width="600" zoomable="yes"}
