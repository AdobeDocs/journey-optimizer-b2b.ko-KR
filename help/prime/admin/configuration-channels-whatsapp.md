...
Journey Optimizer B2B Prime은 Meta의 Cloud API를 통해 WhatsApp 메시지를 전송합니다. 마케터가 개인 여정에 대한 WhatsApp 메시지를 만들려면 먼저 제품 관리자가 WhatsApp 채널을 구성해야 합니다.

![Journey Optimizer B2B Prime에 대한 WhatsApp 작업 흐름](../../user/admin/assets/whatsapp-flow-diagram.png)
...
>[!IMPORTANT]
>
>WhatsApp 메시징 서비스 사용은 Meta의 약관이 적용됩니다. Journey Optimizer B2B Prime을 통해 WhatsApp 메시지에 액세스하면 [Meta WhatsApp 비즈니스 정책](https://www.whatsapp.com/legal/business-policy/)을 검토하고 이에 동의하는 것으로 간주됩니다.

## 제한 사항 {#limitations}

WhatsApp 채널에는 다음 제한 사항이 적용됩니다.

* Adobe Journey Optimizer B2B Prime은 **HIPAA 규정을 준수하지 않고 HIPAA 규정을 준수하지 않습니다**. 또한 서드파티 공급업체는 Adobe의 BAA에 포함되지 않습니다. 자체 규정 준수 및 공급업체 유효성 검사에 대한 책임은 고객에게 있습니다.
...
WhatsApp 메시지를 보내기 전에 Journey Optimizer B2B Prime 환경을 구성하고 WhatsApp 계정과 연결해야 합니다.
...
1. WhatsApp API 자격 증명에 연결할 **[!UICONTROL WhatsApp 비즈니스 계정]**&#x200B;을(를) 선택하십시오.
   ...
   ![WhatsApp 설정 API 자격 증명 비즈니스 계정 선택](../../user/admin/assets/config-whatsapp-channels-api-credentials-details.png){width="500" zoomable="yes"}
...
1. 자격 증명을 외부에서 테스트 - Meta API로 직접 자격 증명을 확인하여 문제가 자격 증명에 의한 문제인지 Journey Optimizer B2B Prime 자격 증명 처리에 의한 문제인지 확인합니다.
...
웹후크를 사용하면 Journey Optimizer B2B Prime이 WhatsApp 비즈니스 계정에서 인바운드 메시지, 동의 응답 및 게재 알림을 받을 수 있습니다. 적절한 동의 관리 및 메시지 추적을 보장하기 위해 웹후크를 구성합니다.
...
1. 받은 메시지가 이 범주의 키워드와 일치할 때 자동으로 보낼 **[!UICONTROL 회신 메시지]**&#x200B;를 입력하세요.
   ...
   ![옵트인 키워드 및 회신 메시지가 있는 WhatsApp 설정 웹후크](../../user/admin/assets/config-whatsapp-channels-webhooks.png){width="500" zoomable="yes"}
...
1. **[!UICONTROL 확인 토큰]** 및 **[!UICONTROL 웹후크 URL]** 값을 복사합니다.
   ...
   ![URL을 복사하고 토큰을 확인하는 WhatsApp 설정 웹후크 설정](../../user/admin/assets/config-whatsapp-channels-webhooks-copy-token-url.png){width="500" zoomable="yes"}
...
1. 메시지 배달에 사용할 **[!UICONTROL 보낸 사람 전화 번호]**&#x200B;을(를) 입력하십시오.
   ...
   ![WhatsApp 채널 구성 세부 정보](../../user/admin/assets/config-whatsapp-channels-general-create.png){width="500" zoomable="yes"}

1. (현재 Journey Optimizer B2B Prime에 적용할 수 없음) **[!UICONTROL WhatsApp 실행 필드]**&#x200B;의 경우 수신자가 여러 개의 전화 번호를 사용할 수 있는 경우 우선 순위 전화 번호로 사용할 프로필 특성을 선택하십시오.
