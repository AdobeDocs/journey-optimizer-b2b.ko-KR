---
title: 컨텐츠 작성 - 구성 요소(Prime)
description: Journey Optimizer B2B Prime에서 컨텐츠 작성에 구성 요소 및 컨텐츠 요소 사용에 대한 섹션을 재사용했습니다
...
1. 콘텐츠 디자인을 시작하려면 **[!UICONTROL Structures]**&#x200B;에서 항목을 드래그하여 캔버스에 놓습니다.
   ...
   이러한 구성 요소의 사용 및 서식 지정에 대한 자세한 내용은 _[구조 구성 요소](../prime/content/structure-components.md)_&#x200B;를 참조하십시오.
...
1. **[!UICONTROL 콘텐츠]** 섹션을 확장하고 하나 이상의 구조 구성 요소에 필요한 만큼 콘텐츠 구성 요소를 추가합니다.
   ...
   * [컨테이너](../prime/content/content-components.md#container)
   * [버튼](../prime/content/content-components.md#button)
   * [텍스트](../prime/content/content-components.md#text)
   * [구분선](../prime/content/content-components.md#divider)
   * [이미지](../prime/content/content-components.md#image)
   * [소셜](../prime/content/content-components.md#social)
   * [양식](../prime/content/content-components.md#form)(랜딩 페이지만)
